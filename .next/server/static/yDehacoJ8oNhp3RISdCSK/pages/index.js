...
const PageIndex = ({
  ...
  const [resultLink, setResultLink] = external_react_default.a.useState('');
  ...
  const onSubmit = async event => {
    ...
    try {
      ...
      const response = await request({
        method: 'post',
        url: '/create-app',
        data: external_qs_default.a.stringify(utils_keysToSnakeCase(input)),
        headers: {
